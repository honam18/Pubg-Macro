...
kiemTraBanQuyen.Open("GET", "https://raw.githubusercontent.com/nguyenvancaoky/blogtruyen.com/master/user.txt", false)
...
Return
Nguyenvancaoky:
MsgBox,,Thông tin, Email : nguyenvancaoky@gmail.com
Return
minimize:
if(min == 0){
Gui, Show, h250, Menu
